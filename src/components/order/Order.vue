<template>
  <div>
    ...
    <el-card>
      <el-row>
        <el-col :span="6">
          <el-input clearable v-model="queryInfo.query" placeholder="请输入内容" @clear="getOrderList">
            <el-button @click="getOrderList" slot="append" type="primary" icon="el-icon-search"></el-button>
          </el-input>
        </el-col>
      </el-row>
